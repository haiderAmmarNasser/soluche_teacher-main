...
class _EventDetailsScreenState extends State<EventDetailsScreen> {
  ...
  void initState() {
    Future.delayed(Duration.zero, () {
      context
          ...
          .fetchEventDetails(eventId: widget.event.id.toString());
    });
    super.initState();
  }
            ...
            child: Padding(
              padding: EdgeInsetsDirectional.only(
                  start: 30 + UiUtils.screenContentHorizontalPadding,
                      ...
                      .screenContentHorizontalPadding), //padding to not hit the back button
              child: Text(
                widget.event.title,
                maxLines: 2,
  ...
  _singleDayItem({required EventSchedule daySchedule}) {
    return Container(
                  ...
                  Text.rich(
                    TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: UiUtils.formatDate(daySchedule.date),
                        ),
                      ],
                      style: TextStyle(
                        height: 1.0,
